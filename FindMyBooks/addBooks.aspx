                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <asp:DropDownList CssClass="form-control" ID="ddlDeptName" runat="server" AutoPostBack ="true" OnSelectedIndexChanged="ddlDeptName_SelectedIndexChanged" ></asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <asp:Label ID="Label1" runat="server" Text="course year :"></asp:Label>
                                                    <div class="form-group">
                                                        <asp:DropDownList CssClass="form-control" ID="ddlAcademicYear" runat="server" AutoPostBack ="true"  OnSelectedIndexChanged="ddlAcademicYear_SelectedIndexChanged"  ></asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
