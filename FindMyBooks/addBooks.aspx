<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="addBooks.aspx.cs" Inherits="FindMyBooks.addBooks" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <script type="text/javascript">
        $(document).ready(function () {
            $(<%=lstSubjectName.ClientID%>).SumoSelect({ placeholder: 'Enter one or more subjects.', okCancelInMulti: true });
        });
        $(document).ready(function () {
            $(<%=lstPublicationName.ClientID%>).SumoSelect({ placeholder: 'Enter publications of your books.', okCancelInMulti: true });
        });
    </script>
                                        ...
                                        <div class="container-fluid" id="inputContainer" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <asp:ListBox CssClass="form-control" ID="lstSubjectName" SelectionMode="Multiple" AutoPostBack="true" runat="server"></asp:ListBox>
<%--                                                        <asp:DropDownList CssClass="form-control" ID="ddlSubjectName" runat="server"></asp:DropDownList>--%>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <asp:ListBox CssClass="form-control" ID="lstPublicationName" SelectionMode="Multiple" AutoPostBack="true" runat="server"></asp:ListBox>
<%--                                                        <asp:DropDownList CssClass="form-control" ID="ddlPublicationName" runat="server"></asp:DropDownList>--%>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <div class="form-group">
                                                    <asp:TextBox CssClass="form-control" ID="TextBox1" placeholder="Make comments if you want." runat="server" TextMode="MultiLine"></asp:TextBox>
                                                        </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-10 mx-auto">
                                <center>
                                    <div class="form-group  fa-pull-right">        <%--in-built class for capturing whole width of the container--%>
                                      <asp:Button Class="btn btn-success btn-lg" ID="addBtn" runat="server" Text="Add Book" OnClick="addBtn_Click"  />
                                    </div>
                                 </center>
                            </div>
                        </div>
